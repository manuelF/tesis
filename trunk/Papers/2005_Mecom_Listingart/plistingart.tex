...
Por ello se han desarrollado las metodolog\'ias h\'ibridas\cite{jejej}, donde a una peque\~na porci\'on del sistema (la parte reactiva), se la trata con la metodolog\'ia cu\'antica, mientras que al resto se lo trata como un campo de fuerzas cl\'asico.
