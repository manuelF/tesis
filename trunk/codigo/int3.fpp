...
c      implicit none
c      real*8 r,a,c,cd,ad,rmm,x,e2,ex,gold,told
c      real*8 eb,ea,ss9,bda,r1,r0,rcond
...
c      real*8 s2pk,t16,t17,d1d,pjdkl,pidkl,pjpkpl,pipkpl,dspl,ddi,ss6s
c      real*8 d2d,s3pk,pi3pk,s1pk,spk,pi2pk,pi1pk,pipk,pj2pk,pj1pk,pjpk
c      real*8 d2pk,t18,d3s,pj3s,p4s,ss5s,pp,wq
      
c      integer natom,iz,nuc,m,ncont,nshell,nucd,md,ncontd,nshelld
c      integer nopt,nmax,nco,nunp,nel,info,irank,md5,md3,m12,m10
c      integer i,j,k1,mmp,kk,k,l,mmem1,m23,m22,m21,m20
