...
La paralelizaci\'on del algoritmo se realiza a trav\'es de la descomposici\'on del dominio de la integral.{\huge Qu\'e integral???}
...
No fueron utilizados m\'as procesadores del cluster debido a que cuanto mayor es la cantidad de procesos utilizados el error introducido por la aritm\'etica finita crece, de forma tal de hacer que los resultados obtenidos no sean utilizables.{\huge esto que decis aca lo comprobaste? Estas seguro que no usaste mas procesadores por una cuestion de error o porque el problema no era lo suficientemente grande?}
...
{\huge no queda más nada que decir sobre estos gráficos que esta frase, la corrida indica algo, da alguna pista interesante, se parece a alg\'un resultado ya obtenido o algo experimental?}
...
Adicionalmente, la performance del programa resulta razonable y el overhead producido se ve compensado por la ventaja de poder tratar sistemas cada vez m\'as grandes. {\huge otra vez lo mismo que dec\'is hace dos parrafos, reforma para decir las cosas una sola vez...}
