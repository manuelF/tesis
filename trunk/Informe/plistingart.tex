...
\end{center}
\caption[Speedup del programa con reordenamiento de c\'alculo en 2 procesos en una m\'aquina SMP Xeon Dual, Papita, con una entrada de 7 \'atomos.]{\small{Speedup del programa con reordenamiento de c\'alculo en 2 procesos en una m\'aquina SMP Xeon Dual, Papita, con una entrada de 7 \'atomos.}}
...
\end{center}
\caption[Eficiencia del programa con reordenamiento de c\'alculo en 2 procesos en una m\'aquina SMP Xeon Dual, Papita, con una entrada de 7 \'atomos.]{\small{Eficiencia del programa con reordenamiento de c\'alculo en 2 procesos en una m\'aquina SMP Xeon Dual, Papita, con una entrada de 7 \'atomos.}}
%{\huge idem.}}
...
\end{center}
\caption[Overhead del programa con reordenamiento de c\'alculo en 2 procesos en una m\'aquina SMP Xeon Dual, Papita, con una entrada de 7 \'atomos.]{\small{Overhead del programa con reordenamiento de c\'alculo en 2 procesos en una m\'aquina SMP Xeon Dual, Papita, con una entrada de 7 \'atomos.}}
%{\huge idem.}}
\label{fig:Overhead}
\end{figure}
...
\end{tabular}
\end{center}
\caption[Tiempos de ejecuci\'on total del programa serial y el paralelo en 2 y 4 procesos con una entrada de 7 \'atomos]{\small{Tiempos de ejecuci\'on total del programa serial y el paralelo en 2 y 4 procesos con una entrada de 7 \'atomos.}}
