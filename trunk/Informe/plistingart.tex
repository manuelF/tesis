...
{\Huge Esto te parece una interpretacion? A mi me parece una copia de lo que dice arriba. Si vas a poner esto, explica que significa cada uno de los items que reporta, para copiar esta el parrafo de arriba con el resultado}
\begin{itemize}
...
\item {\it Memoria}: (0 avgtext + 0 avgdata 0 maxresident)k
\item {\it I/O}: 0 lecturas, 0 escrituras
\item {\it Paginaci\'on}: (1109 major + 3084 minor)pagefaults, 0 swaps
\end{itemize}
...
{\Huge Se sincronizan todos los procesos contra todos, no? Si es asi ponelo.}
