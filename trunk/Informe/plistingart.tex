...
\end{tabular}
\end{center}
\caption[Speedup, Eficiencia y Overhead en m\'aquina SMP Xeon Dual con reordenamiento de c\'alculo]{\small{Speedup, Eficiencia y overhead del programa en una m\'aquina SMP Xeon Dual con 4 \'atomos con reordenamiento de c\'alculo en el programa.} {\huge Indicar que el overhead es sobre el tiempo total, ya que no coincide con la definicion dada anteriormente}}
...
El mismo est\'a compuesto por 17 nodos Intel SMP Xeon duales. {\huge Decir porque no podes usar los 17*2 procesadores que hay en el cluster y porque elegis correr un proceso por maquina.}
...
Con la implementaci\'on que finalmente se utiliz\'o en este estudio se logr\'o una aproximaci\'on al sistema serial que aunque no otorga resultados exactamente iguales los mismos son muy similares y aceptados por los expertos del \'area. {\huge esto no se entiende que queres decir, la perdida de precision es la ``misma'' que la producida por la versi\'on serial, no?}
