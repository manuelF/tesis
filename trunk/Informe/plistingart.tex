...
Los modelos de agua utilizados por el sistema serial son el \textsf{TIP4P} y el \textsf{TIP4P-FQ}.
...
\item En el modelo \textsf{TIP4P-FQ}, para incluir los efectos de la polarizaci\'on en un modelo de agua, se tiene en cuenta que el momento dipolar de cada mol\'ecula depende del campo el\'ectrico y \'este, a su vez, depende de los momentos dipolares. Para incluir estos efectos se realiza una din\'amica ficticia de las cargas.
