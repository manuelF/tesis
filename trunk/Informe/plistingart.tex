...
En una primera etapa, como puede observarse en la figura \ref{fig:peroxinitrito4}, el peroxinitrito se adiciona al $CO_{2}$ formando un aducto (el nitrosoperoxicarbonato). Este aducto se descompone en los radicales carbonato y $NO_{2}$ encerrados en una caja de solvente. A su vez, estos radicales pueden reacomodarse de manera tal que conforman otro aducto llamado nitrocarbonato, o bien pueden liberarse como tales.
