...
No fueron utilizados m\'as procesadores del cluster debido a que con las entradas con las que se realizaron las pruebas no es posible exigir ejecuciones corridas con un n\'umero de procesos mayor a cuatro.
%{\huge sigo sin entender esta parte, la idea era obtener un programa escalable, ahora bien si a partir de 4 procesos el programa se cae al carajo, no se entiende de que va la cosa. No querr\'as decir que con la entrada de prueba que estas usando para esta parte no podes exigirle m\'as que 4 procesos?} 
