...
\end{center}
\caption[Speedup del programa con reordenamiento de c\'alculo en 2 procesos.]{\small{Speedup del programa con reordenamiento de c\'alculo en 2 procesos.} {\huge poner alg\'un dato de la corrida, recorda que la figura debe entederse solo con mirar el caption.}}
\label{fig:Speedup}
\end{figure}
...
\end{center}
\caption[Eficiencia del programa con reordenamiento de c\'alculo en 2 procesos.]{\small{Eficiencia del programa con reordenamiento de c\'alculo en 2 procesos.} {\huge idem.}}
...
\end{center}
\caption[Overhead del programa con reordenamiento de c\'alculo en 2 procesos.]{\small{Overhead del programa con reordenamiento de c\'alculo en 2 procesos.}{\huge idem.}}
\label{fig:Overhead}
\end{figure}
...
\end{tabular}
\end{center}
\caption[Tiempos de ejecuci\'on total del programa en 2 y 4 procesos]{\small{Tiempos de ejecuci\'on total del programa en 2 y 4 procesos.} {\huge aca hay tres filas, aunque el caption diga que hay dos cosas. Ademas podr\'ias poner qu\'e corriste.}}
...
\end{center}
\caption[Tiempos de ejecuci\'on total del programa en 4 procesos]{\small{Tiempos de ejecuci\'on total del programa en 4 procesos.} {\huge De nuevo, hay tres cosas graficadas... pone info de qu\'e corrida estas hablando.}}
...
Para diversas corridas nuevas se utiliz\'o una SMP Xeon Dual debido a que la ganancia de la misma era de un $15\%$ aproximadamente en el caso de Papita, y alrededor de un $50\%$ {\huge estas seguro de esto, en que condiciones, aclara por que suena MUY raro que ande mejor que en una SMP} en el caso de cada nodo del cluster \emph{FIUPG}, lo cual reduc\'ia los tiempos de investigaci\'on de forma notoria. Se opt\'o por este tipo de m\'aquina porque los costos de comunicaci\'on mediante buses externos afectan la performance.
