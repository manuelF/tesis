...
Para construir estos grupos se genera un mallado en cubos y esferas para poder englobar todos los puntos
de la grilla. Como los puntos no se distribuyen equidistantemente, estos volumenes no son identicos;
se construyen con un tama\~no m\'aximo para los cubos, y un radio m\'aximo para las esferas. Existe
una esfera por cada n\'ucleo at\'omico, de reducido tama\~no pero con una gran densidad de puntos y funciones.
Los cubos luego engloban todos los puntos que no fueron ya seleccionados por las esferas, por lo que
su tama\~no puede variar considerablemente. Este esquema de construcci\'on se detalla en la figura~\ref{fig:grilla}
y el detalle algoritmico de la generaci\'on se estudio previamente~\cite{LIO}~\cite{TesisNitsche},
