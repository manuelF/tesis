...
\begin{subfigure}[b]{\plotwidthtres}
 ...
 \end{subfigure}
 \caption{Porcentajes de tiempo de los pasos de XC corriendo Hemoglobina en una Tesla K40 antes y despues de
...
\begin{subfigure}[b]{\plotwidthtres}
 ...
 \end{subfigure}
 \caption{Porcentajes de tiempo de SCF corriendo Hemoglobina en una Tesla K40 antes y despues de
 las optimizaciones realizadas.}
 \label{plt:cuda-scf}
\end{figure}
