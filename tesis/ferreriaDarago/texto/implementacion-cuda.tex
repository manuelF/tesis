...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=250px]{plots/cuda/global-fullereno.png}
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=250px]{plots/cuda/global-detailed-fullereno.png}
   \caption{Aceleraci\'on del c\'alculo de una iteraci\'on de SCF en funci\'on del porcentaje de memoria
...
\begin{figure}[htbp]
   \centering
   %TODO
   \includegraphics[width=250px]{plots/cuda/global-functions-acc.png}
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=250px]{plots/cuda/shared-4vs3.png}
