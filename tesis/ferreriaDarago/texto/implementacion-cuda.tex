...
mejor a\'un es tener dos warps ejecutando simultáneamente, ya que
...
el m\'aximo valor posible todavia usando el modelo de memoria compartida.
...
Otro de los problemas existentes del c\'odigo que se busc\'o autacar fue el mejor empleo de las
...
la cantidad de memoria necesaria para operar. Se compar\'o tambien contra el predictor usado
...
Como podemos apreciar, se puede ver una relaci\'on entre  el tiempo de resoluci\'on con el tama\~no
...
para terminar de balancear est\'aticamente. Esto lo podemos hacer ya que, como se mostr\'o en la figura~\ref{fig:global-fullereno},
