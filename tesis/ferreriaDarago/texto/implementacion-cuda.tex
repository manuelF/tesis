...
%   % \includegraphics[width=\textwidth]{plots/cuda/cost-predictor-fullereno.png}
%   % \caption{Fullereno}
%   %\end{subfigure}
%   \begin{subfigure}[b]{\plotwidthtres}
%    \caption{Hemoglobina}
%   \end{subfigure}
%   %\begin{subfigure}[b]{\plotwidthtres}
%   % \includegraphics[width=\textwidth]{plots/cuda/sizeingpu-predictor-caroteno.png}
%   % \includegraphics[width=\textwidth]{plots/cuda/cost-predictor-caroteno.png}
%   % \caption{Caroteno}
%   %\end{subfigure}
%
...
para terminar de balancear est\'aticamente. Esto lo podemos hacer ya que, como mostramos en la figura~\ref{fig:runtime-fullereno},
...
El problema ejemplar elegido en este caso es realizar $10$ iteraciones del kernel de c\'omputo de la matriz de Fock.
