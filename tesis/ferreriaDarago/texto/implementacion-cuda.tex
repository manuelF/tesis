...
en las GPU m\'as veloces del mercado (Tesla K20, GeForce GTX 780).

Los problemas principales que mostraba esta kernel son:
\begin{itemize}
\item Cantidad de accesos a memoria global
\item Falta de accesos coalescentes a memoria
...
el ancho de banda de transferencia.
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=250px]{plots/cuda/threading.png}
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=250px]{plots/cuda/dbs.png}
...
puesto que estas cuentas se pueden hacer m\'as rapido en GPU.

Cuando la aplicacion original se concibi\'o, no habia siquiera placas Tesla de GPGPU apuntadas a HPC, con
...
finalizar el programa). Esto ademas es configurable de modo que una ejecucion pueda usar un porcentaje
...
de la memoria global que tienen su equivalente en la linea Tesla. Esto sin embargo, es mitigado
cuando se computa m\'ultiples placas, que tambien distribuyen el almacenamiento ademas del computo.
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=250px]{plots/cuda/4placas-simple.png}
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=250px]{plots/cuda/4placas-doble.png}
