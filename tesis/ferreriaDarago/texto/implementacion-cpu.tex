        ...
        \begin{algorithmic}
            \Function{solve}{$PG : PointGroup$}
              ...
              \ForAll{$p \in puntos(PG)$}
                  ...
                  \State Calcular contribuci\'on a Fuerzas y Kohn-Sham $FR_p$ con el potencial y el peso del punto.
              \EndFor
...
Tambi\'en notamos que los accesos de $hess_1$ y $hess_2$ se producen en las componentes
pares e impares del hessiano, respectivamente. Si separamos estas en dos matrices
separadas, entonces tambi\'en tendremos que todas las componentes estar\'an
