...
Mejoras en este nivel eran usualmente \todo{dejaron de ser invisible?} invisibles al programador, dependiendo de los compiladores optimizantes, pero sus ventajas fueron disminuyendo a partir del a\~no 2000.
...
El paralelismo de datos puede ser explotado por el compilador, que analiza los ciclos de programa y detecta cuando hay operaciones \todo{Hay una figura en la p\'agina de intel que muestra esto, recomiendo ponerlo porque sino no se entiende} independientes que pueden ser realizadas en simult\'aneo, dividiendo la cantidad de instrucciones totales que tiene que realizar un procesador.
