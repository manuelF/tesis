...
Un resultado importante a tener en cuenta es la denominada \textit{Ley de Amdahl}\, que establece una relaci\'on entre el \textit{speedup} m\'aximo alcanzable mediante un incremento en la cantidad de procesadores disponibles, el porcentaje
