...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=\plotwidthtres]{plots/otros/comparacion-tiempos-sistemas.png}
...
de QM, importante en simulaciones de \textit{Time-Dependant Density Functional Theory} por ejemplo, para no
