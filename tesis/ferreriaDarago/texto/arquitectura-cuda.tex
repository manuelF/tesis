...
como la mayor\'ia de las caches de procesadores normales (i.e. dato-1, dato, dato+1, etc.), sino que se le
...
Hasta ahora, solo consideramos GPGPU de forma aislada, viendo las prestaciones del hardware y un m\'inimo
...
Podemos observar entonces que las unidades que verdaderamente realizan las operaciones l\'ogico-aritm\'eticas,
