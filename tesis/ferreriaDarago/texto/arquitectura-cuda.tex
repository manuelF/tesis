...
eficientemente ($<25 \mu$s ~\cite{PattersonFermi}). Con esto, pueden ejecutar
...
por los clusters en el ranking TOP500, donde se ordenan de acuerdo al pico medible.
