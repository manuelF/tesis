...
Los resultados vistos en la secci\'on \ref{tamgrupos} muestran muy claramente que existe algun criterio
para poder separar grupos en CPU y GPU y que, al poder realizarse en paralelo, podrian explotar
