...
El c\'alculo de $E_{QM}$ y $E_{QM/MM}$ son realizados por la aplicaci\'on LIO~\cite{LIO,TesisNitsche}, el cual fue optimizado en este trabajo para el uso de distintas arquitecturas de CPU y GPGPU. 
...
Entre 1986 y 2002, la performance de los procesadores creci\'o, en promedio, un $50\%$ por a\~no~\cite{Pacheco}. 
